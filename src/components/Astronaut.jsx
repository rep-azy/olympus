...
export function Astronaut(props) {
    ...
    const ySpr = useSpring(yPos, { damping: 40 });
    ...
    useFrame(() => {
        group.current.position.y = ySpr.get();
    });
    
    return (
        <group ref={group} {...props} dispose={null} rotation={[-Math.PI / 2, -0.2, 2.2]} scale={props.scale || 0.3} position={props.position || [1.3, -1, 0]}>
