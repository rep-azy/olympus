            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12">
                ...
                <div className="grid-default-color grid-2">
                    <div ref={grid2Container} className="flex items-center justify-center w-full h-full">
                        {/* Background */}
                        <p className="flex items-end text-5xl text-gray-500 select-none">CODE IS CRAFT</p>
                        {/* Bouncing Text */}
                        <Card style={{ rotate: "75deg", top: "30%", left: "20%" }} text="GRASP" containerRef={grid2Container} />
                        <Card style={{ rotate: "-30deg", top: "60%", left: "45%" }} text="DESIGN" containerRef={grid2Container} />
                        <Card style={{ rotate: "90deg", top: "30%", left: "70%" }} text="SOLID" containerRef={grid2Container} />
                        <Card style={{ rotate: "-45deg", top: "55%", left: "0%" }} text="PATTERN" containerRef={grid2Container} />
                        <Card style={{ rotate: "20deg", top: "10%", left: "38%" }} text="PRINCIPLES" containerRef={grid2Container} />
                        {/* Bouncing Images */}
